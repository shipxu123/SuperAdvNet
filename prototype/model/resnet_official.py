...
__all__ = ['ResNet', 'cifar_resnet18', 'resnet18_official', 'cifar_resnet50', 'resnet34_official', 'resnet50_official', 'resnet101_official',
...
def cifar_resnet18(**kwargs):
    ...
    """
    model = CIFAR_ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model
...
def cifar_resnet50(**kwargs):
    ...
    """
    model = CIFAR_ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    return model
