...
__all__ = ['bignas_resnet50_2954M', 'bignas_resnet50_3145M', 'bignas_resnet50_3811M']
...
class BigNAS_ResNet_Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        - expand_ratio (:obj:`list` of 5 (stages+1) or (blocks+1) ints): expand ratio list for blocks
    ...
    def zero_last_gamma(self):
        for m in self.modules():
            if isinstance(m, BottleneckBlock):
                if m.shortcut is None:
                    m.point_conv2.bn.weight.data.zero_()


def bignas_resnet50_2954M(**kwargs):
    """
    equal to ResNet50
    """
...
def bignas_resnet50_3145M(**kwargs):
    """
    equal to ResNet50
    """
...
def bignas_resnet50_3811M(**kwargs):
    """
    equal to ResNet50
    """
