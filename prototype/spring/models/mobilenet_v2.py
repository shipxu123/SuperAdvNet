...
__all__ = ['mobilenet_v2_x0_5', 'mobilenet_v2_x0_75', 'mobilenet_v2_x1_0',
           'mobilenet_v2_x1_4']


model_urls = {
    'mobilenet_v2_x0_5': 'http://spring.sensetime.com/drop/$/leaNK.pth',
    'mobilenet_v2_x0_75': 'http://spring.sensetime.com/drop/$/5ny9B.pth',
    'mobilenet_v2_x1_0': 'http://spring.sensetime.com/drop/$/8xg64.pth',
    'mobilenet_v2_x1_4': 'http://spring.sensetime.com/drop/$/a4FCp.pth'
}
...
def mobilenet_v2_x1_4(pretrained=False, **kwargs):
    """
    Constructs a MobileNet-V2 model.
    """
    kwargs['scale'] = 1.4
    model = MobileNetV2(**kwargs)
    model.performance = model_performances['mobilenet_v2_x1_4']
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(model_urls['mobilenet_v2_x1_4'], map_location='cpu')
        state_dict = modify_state_dict(model, state_dict)
        model.load_state_dict(state_dict, strict=False)
    return model
...
if __name__ == '__main__':
    ...
    SPRING_MODELS_REGISTRY.register('mobilenet_v2_x1_0', mobilenet_v2_x1_0)

    cls_model = SPRING_MODELS_REGISTRY['mobilenet_v2_x1_0'](pretrained=True)
    det_model = SPRING_MODELS_REGISTRY['mobilenet_v2_x1_0'](
