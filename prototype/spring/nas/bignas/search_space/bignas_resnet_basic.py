...
from ..backbone.bignas_resnet_basic_subnet import bignas_resnet_basic
...
class Big_ResNet_Basic(Bignas_SearchSpace):
    ...
    def __init__(self,
                 ...
                 # search space
                 **kwargs):
        super(Big_ResNet_Basic, self).__init__(**kwargs)
        r"""
        Arguments:
...
def big_resnet_basic(**kwargs):
    return Big_ResNet_Basic(**kwargs)
...
if __name__ == '__main__':
    ...
    SPRING_MODELS_REGISTRY.register('big_resnet_basic', big_resnet_basic)

    cls_model = SPRING_MODELS_REGISTRY['big_resnet_basic']
    det_model = SPRING_MODELS_REGISTRY['big_resnet_basic'](
