...
if __name__ == '__main__':
    ...
    SPRING_MODELS_REGISTRY.register('bignas_resnet_basic', bignas_resnet_basic)

    cls_model = SPRING_MODELS_REGISTRY['bignas_resnet_basic']()
    det_model = SPRING_MODELS_REGISTRY['bignas_resnet_basic'](
